  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="" class="menu-link active">
                  <div data-i18n="Without menu">Customer Insert</div>
                </a>
              </li>
            </ul>
          </li>
      ...
      <div class="layout-page">
        <nav class="navbar navbar-expand-xl navbar-detached navbar-light">
          <div class="container-fluid">
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                <li class="nav-item lh-1 me-3">
                  <h4 class="mb-0">Customer Insert</h4>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form id="customerForm" action="https://example.com/submit" method="POST">
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        <label for="customer_status" class="col-sm-2 col-form-label">Status</label>
                        <div class="col-sm-10">
