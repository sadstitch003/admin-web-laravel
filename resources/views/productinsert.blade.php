              ...
              <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                  <div class="row p-5">
                    ...
                    <form action="{{  route('insertRoute')  }}" method="POST">
                      {{ csrf_field() }}
                      <div class="form">
                        <div class="row">
                          <div class="col-xl-7 col-md-8 mb-3">
                            <label for="prod-id" class="form-label">Product ID</label>
                            <input type="text" name="PRODID" placeholder = "auto generated by system" id="ID" class="form-control shadow-none" readonly="true" required>
                          </div>
                          <div class="col-xl-7 col-md-8 mb-3">
                            <label for="prod-name" class="form-label">Product Name</label>
                            <input type="text" name="NAME" placeholder = "Product Name" id="prod-name" class="form-control shadow-none" required>
                          </div>
                          <div class="col-xl-7 col-md-8 mb-3">
                        ...
                        <div class="col-xl-7 col-md-8 mb-3">
                          <div class="row justify-content-between">
                            <div class="col-xl-6 col-md-12">
                              ...
                              <input type="number" placeholder="0" id="prod-price" name="PRICE" class="form-control shadow-none" required>
                            </div>
                            <div class="col-xl-6 col-md-12">
                              <label for="prod-stock" class="form-label">Stock</label>
                              <input type="number"  placeholder="0" id="prod-stock" name="STOCK" class="form-control shadow-none" required>
                            </div>
                          </div>
                        </div>
                        <div class="col-xl-7 col-md-8 mb-3">
                          <label for="prod-desc" class="form-label">Description</label>
                          <textarea name="DESC" id="prod-desc" placeholder = "Product description here" class="form-control shadow-none" required></textarea>
                        </div>
                        <div class="col-xl-7 col-md-8 mb-3">
