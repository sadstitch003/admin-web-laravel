                    ...
                    <div class="form">
                      <div class="row">
                        <div class="col-xl-7 col-md-8 mb-3">
                          ...
                          <input type="text" placeholder="auto generated by system" id="prod-id" class="form-control shadow-none" disabled>
                        </div>
                        <div class="col-xl-7 col-md-8 mb-3">
                        ...
                        <div class="col-xl-7 col-md-8 mb-3">
                          <div class="row justify-content-between">
                            <div class="col-xl-6 col-md-12">
                              ...
                              <input type="number" placeholder="0" id="prod-price" class="form-control shadow-none">
                            </div>
                            <div class="col-xl-6 col-md-12">
                              <label for="prod-qty" class="form-label">Stock</label>
                              <input type="number" placeholder="0" id="prod-qty" class="form-control shadow-none">
                            </div>
                          </div>
                        </div>
                        <div class="col-xl-7 col-md-8 mb-3">
                          <label for="prod-desc" class="form-label">Description</label>
                          <textarea placeholder="Product Description" id="prod-desc" class="form-control shadow-none"></textarea>
                        </div>
                        <div class="col-xl-7 col-md-8 mb-3">
